...
file_to_load = os.path.join("C:\Users\Lindsay Vitols\Documents\GitHub\Election-Analysis\resources\elections_results.csv")
# Add a variable to save the file to a path.
file_to_save = os.path.join("C:\Users\Lindsay Vitols\Documents\GitHub\Election-Analysis\analysis\election_analysis.txt")
